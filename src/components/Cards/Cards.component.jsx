            ...
            <Grid container spacing={3} justify='center'>
                <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.infected)}>
                    <CardContent>
                        ...
                        <Typography variant='h5'><CountUp start={0} end={confirmed.value} duration={2.75} separator="," /></Typography>
                ...
                <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.active)}>
                    <CardContent>
                        ...
                        <Typography variant='h5'><CountUp start={0} end={confirmed.value-(recovered.value)} duration={2.75} separator="," /></Typography>
                        <Typography color='textSecondary'>{new Date(lastUpdate).toDateString()}</Typography>
                        <Typography variant='body2'>Number of active Covid19 cases</Typography>
                    </CardContent>
                </Grid>
